  ...
  const sidebar = (
    <div className="flex flex-col h-full">
      ...
      <div className="px-3 py-3">
        <div className="px-3 py-2.5 rounded-lg bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border border-blue-500/20">
          <div className="flex items-center gap-2 mb-1">
            <GraduationCap className="w-4 h-4 text-blue-400" />
            <span className="text-xs font-bold text-blue-300 uppercase tracking-wider">Student</span>
          </div>
          <p className="text-xs font-semibold text-sidebar-foreground truncate">{student.name}</p>
          <p className="text-[10px] text-sidebar-muted">{student.enrollmentNo} · {student.batch}</p>
        </div>
      </div>

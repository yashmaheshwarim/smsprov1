    ...
    try {
      ...
      if (data && data.length > 0) {
        ...
        setResults([
          ...
          { id: "4", examName: "Mid-Term", subject: "Physics", marksObtained: 78, totalMarks: 100, percentage: 78, grade: "B+", date: "2025-02-15" },
          { id: "5", examName: "Mid-Term", subject: "Chemistry", marksObtained: 82, totalMarks: 100, percentage: 82, grade: "A", date: "2025-02-15" },
          { id: "6", examName: "Mid-Term", subject: "Mathematics", marksObtained: 91, totalMarks: 100, percentage: 91, grade: "A+", date: "2025-02-15" },
        ]);
      }
    } catch {
      setResults([]);
  ...
  return (
    <div className="p-4 lg:p-6 space-y-6 animate-fade-in">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Your exam performance and grades</p>
      </div>
